...
func (svc *ManageHistory) _FindFirstRule(tv *transports.ThingMessage) *historyapi.RetentionRule {
...
func (svc *ManageHistory) _IsRetained(tv *transports.ThingMessage) (bool, *historyapi.RetentionRule) {
