...
type GetPropertiesFunc func(thingAddr string, names []string) things.ThingMessageMap
...
// Latest Properties are tracked in a 'latest' record which holds a map of propertyName:ThingMessage records
//
