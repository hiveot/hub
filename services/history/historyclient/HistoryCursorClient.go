...
func (cl *HistoryCursorClient) First() (thingValue *transports.NotificationMessage, valid bool, err error) {
	req := historyapi.CursorArgs{
		CursorKey: cl.cursorKey,
	}
	resp := historyapi.CursorSingleResp{}
	err = cl.cc.Rpc(wot.OpInvokeAction, cl.dThingID, historyapi.CursorFirstMethod, &req, &resp)
...
func (cl *HistoryCursorClient) Last() (
	...
	resp := historyapi.CursorSingleResp{}
	err = cl.cc.Rpc(wot.OpInvokeAction, cl.dThingID, historyapi.CursorLastMethod, &req, &resp)
	return resp.Value, resp.Valid, err
}
...
func (cl *HistoryCursorClient) Next() (
	...
	resp := historyapi.CursorSingleResp{}
	err = cl.cc.Rpc(wot.OpInvokeAction, cl.dThingID, historyapi.CursorNextMethod, &req, &resp)
	return resp.Value, resp.Valid, err
}
...
func (cl *HistoryCursorClient) NextN(
	limit int, until string) (batch []*transports.NotificationMessage, itemsRemaining bool, err error) {
	...
	err = cl.cc.Rpc(wot.OpInvokeAction, cl.dThingID, historyapi.CursorNextNMethod, &req, &resp)
...
func (cl *HistoryCursorClient) Prev() (
	...
	resp := historyapi.CursorSingleResp{}
	err = cl.cc.Rpc(wot.OpInvokeAction, cl.dThingID, historyapi.CursorPrevMethod, &req, &resp)
	return resp.Value, resp.Valid, err
}
...
func (cl *HistoryCursorClient) PrevN(
	...
	resp := historyapi.CursorNResp{}
	err = cl.cc.Rpc(wot.OpInvokeAction, cl.dThingID, historyapi.CursorPrevNMethod, &req, &resp)
	return resp.Values, resp.ItemsRemaining, err
}
...
func (cl *HistoryCursorClient) Release() {
	...
	err := cl.cc.Rpc(wot.OpInvokeAction, cl.dThingID, historyapi.CursorReleaseMethod, &req, nil)
	_ = err
	return
}
...
func (cl *HistoryCursorClient) Seek(timeStamp time.Time) (
	...
	resp := historyapi.CursorSingleResp{}
	err = cl.cc.Rpc(wot.OpInvokeAction, cl.dThingID, historyapi.CursorSeekMethod, &req, &resp)
	return resp.Value, resp.Valid, err
}
...
func NewHistoryCursorClient(cc transports.IConsumerConnection, cursorKey string) *HistoryCursorClient {
