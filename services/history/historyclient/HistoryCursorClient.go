...
func (cl *HistoryCursorClient) First() (thingValue *transports.ResponseMessage, valid bool, err error) {
...
func (cl *HistoryCursorClient) NextN(
	limit int, until string) (batch []*transports.ResponseMessage, itemsRemaining bool, err error) {
