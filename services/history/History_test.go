...
func makeValueBatch(publisherID string, nrValues, nrThings, timespanSec int) (
	...
	for j := 0; j < nrValues; j++ {
		...
		ev := things.NewThingMessage(transports.MessageTypeEvent,
...
func TestAddPropertiesEvent(t *testing.T) {
	...
	props1 := &things.ThingMessage{
		AgentID: agent1,
		ThingID: thing1ID,
		Name:    transports.EventTypeProps,
		Data:    propsValue,
	}
