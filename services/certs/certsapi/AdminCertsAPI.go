...
// CertsAdminAgentID is the connect ID of the agent connecting to the Hub
const CertsAdminAgentID = "certs"

// CertsAdminThingID is the ID of the service exposed by the agent
const CertsAdminThingID = "admin"
