...
func NewHandleAdminRequest(svc IAdminService) func(msg *msg.RequestMessage, c transport.IConnection) *msg.ResponseMessage {
	return func(msg *msg.RequestMessage, c transport.IConnection) *msg.ResponseMessage {
		var output any
		var err error
		switch msg.Name {
		case "startPlugin":
