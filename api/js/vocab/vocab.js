...
export const OpUnobserveAction = "unobserveaction"
export const OpUnobserveAllActions = "unobserveallactions"
...
export const UnitHectoPascal = "hiveot:unit:hectopascal";
...
export const UnitMilliMeter = "hiveot:unit:millimeter";
...
export const PropEnvPrecipitation = "hiveot:prop:env:precipitation";
export const PropEnvPrecipitationRain = "hiveot:prop:env:precipitation:rain";
export const PropEnvPrecipitationSnow = "hiveot:prop:env:precipitation:snow";
export const PropEnvPressure = "hiveot:prop:env:pressure";
export const PropEnvPressureSeaLevel = "hiveot:prop:env:barometer:msl";
export const PropEnvPressureSurface = "hiveot:prop:env:barometer:surface";
...
export const PropEnvWindGusts = "hiveot:prop:env:wind:gusts";
