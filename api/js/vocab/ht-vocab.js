...
export const EventTypeDeliveryUpdate = "$delivery"
...
export const PostSubscribePath = "/subscribe/{thingID}/{key}"
export const PostUnsubscribePath = "/unsubscribe/{thingID}/{key}"
