...
export const DeleteThingPath = "/things/{thingID}"
export const GetActionHistoryPath = "/history/{thingID}/action/{key}"
export const GetActionsPath = "/things/{thingID}/actions"
export const GetEventHistoryPath = "/history/{thingID}/event/{key}"
export const GetEventsPath = "/things/{thingID}/events"
export const GetPropertiesPath = "/things/{thingID}/properties"
export const GetThingPath = "/things/{thingID}"
export const GetThingsPath = "/things"
export const PostActionPath = "/things/{thingID}/action/{key}"
export const PostEventPath = "/things/{thingID}/event/{key}"
export const PostLoginPath = "/authn/login"
export const PostLogoutPath = "/authn/logout"
export const PostPropertiesPath = "/things/{thingID}/properties"
export const PostRefreshPath = "/authn/refresh"
export const PostThingPath = "/things/{thingID}"
