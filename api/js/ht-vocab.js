...
export const ActionTypeProperties = "$properties"
export const EventTypeProperties = "$properties"
export const EventTypeTD = "$td"
...
export const AgentDeleteThingPath = "/agent/{thingID}"
export const AgentGetActionsPath = "/agent/{thingID}/actions"
export const AgentPostEventPath = "/agent/{thingID}/event/{key}"
export const AgentPostEventsPath = "/agent/{thingID}/events"
export const AgentPutPropertiesPath = "/agent/{thingID}/properties"
export const AgentPutPropertyPath = "/agent/{thingID}/property"
export const AgentPutThingPath = "/agent/{thingID}"
export const ConnectSSEPath = "/sse"
export const ConnectWSPath = "/ws"
export const ConsumerDeleteThingPath = "/things/{thingID}"
export const ConsumerGetActionPath = "/things/{thingID}/actions/{key}"
export const ConsumerGetActionsPath = "/things/{thingID}/actions"
export const ConsumerGetEventPath = "/things/{thingID}/events/{key}"
export const ConsumerGetEventsPath = "/things/{thingID}/events"
export const ConsumerGetPropertiesPath = "/things/{thingID}/properties"
export const ConsumerGetPropertyPath = "/things/{thingID}/properties/{key}"
export const ConsumerGetThingPath = "/things/{thingID}"
export const ConsumerGetThingsPath = "/things"
export const ConsumerPostActionPath = "/things/{thingID}/actions/{key}"
export const ConsumerPostPropertiesPath = "/things/{thingID}/properties"
export const ConsumerPutPropertyPath = "/things/{thingID}/properties/{key}"
export const PostLoginPath = "/rpc/authn/login"
export const PostRPCPath = "/rpc/{thingID}/{key}"
export const PostRefreshPath = "/rpc/authn/refresh"
// end of HttpPaths
