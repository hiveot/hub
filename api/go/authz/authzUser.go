...
func UserSetPermissions(hc transports.IClientConnection, permissions ThingPermissions) (err error) {

	err = hc.SendRequest("invokeaction", UserDThingID, UserSetPermissionsMethod, &permissions, nil)
	return
}
...
// NewHandleUserAction returns an agent handler for Thing 'dtw:authz:user' actions.
//
