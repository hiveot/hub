...
func UserSetPermissions(td1 *td.TD, hc transports.IClientConnection, permissions ThingPermissions) (err error) {

	f := td1.GetForm("invokeaction", UserSetPermissionsMethod, hc.GetProtocolType())
	err = hc.SendRequest(f, UserDThingID, UserSetPermissionsMethod, &permissions, nil)
	return
}
