...
func NewAdminHandler(svc IAdminService) func(*hubclient.ThingMessage) hubclient.DeliveryStatus {
...
const AdminTD = `{"@context":["https://www.w3.org/2022/wot/td/v1.1",{"ht":"https://www.hiveot.net/vocab/v0.1"}],"@type":"Service","created":"2024-06-04T17:00:00.000Z","description":"HiveOT runtime service for administration of roles and permissions","id":"admin","modified":"2024-06-04T17:00:00.000Z","support":"https://www.github.com/hiveot/hub","title":"Authorization Administration Service","actions":{"getClientRole":{"@type":"ht:function","title":"Get Client Role","description":"Read the role of a client","input":{"title":"ClientID","description":"ID of the service, agent or consumer","readOnly":false,"type":"string"},"output":{"title":"Role","description":"Response with client role","readOnly":false,"type":"string"},"safe":true,"idempotent":true},"setClientRole":{"@type":"ht:function","title":"Set Client Role","description":"Update the role of a consumer","input":{"readOnly":false,"type":"object","properties":{"clientID":{"title":"Client ID","readOnly":false,"type":"string"},"role":{"title":"Client Role","readOnly":false,"type":"string"}}},"idempotent":true}},"security":["bearer"],"securityDefinitions":{"bearer":{"scheme":""}}}`
