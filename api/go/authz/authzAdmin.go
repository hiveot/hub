...
func AdminGetClientRole(hc transports.IConsumer, clientID string) (role ClientRole, err error) {
...
func AdminSetClientRole(hc transports.IConsumer, clientID string, role ClientRole) (err error) {
...
const AdminTD = `{"actions":{"getClientRole":{"@type":"ht:function","description":"Read the role of a client","title":"Get Client Role","idempotent":true,"input":{"title":"ClientID","description":"ID of the service, agent or consumer","readOnly":false,"type":"string"},"output":{"title":"Role","description":"Response with client role","readOnly":false,"type":"ClientRole"},"safe":true},"setClientRole":{"@type":"ht:function","description":"Update the role of a consumer","title":"Set Client Role","idempotent":true,"input":{"readOnly":false,"type":"object","properties":{"clientID":{"title":"Client ID","readOnly":false,"type":"string"},"role":{"title":"Client Role","readOnly":false,"type":"ClientRole"}}}}},"allow":["admin"],"@context":["https://www.w3.org/2022/wot/td/v1.1",{"ht":"https://www.hiveot.net/vocab/v0.1"}],"@type":"Service","created":"2024-06-04T17:00:00.000Z","description":"HiveOT runtime service for administration of roles and permissions","id":"admin","modified":"2024-06-04T17:00:00.000Z","security":["bearer"],"securityDefinitions":{"bearer":{"scheme":""}},"title":"Authorization Administration Service","support":"https://www.github.com/hiveot/hub"}`
