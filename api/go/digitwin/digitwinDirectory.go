...
const (
	...
	DirectoryActionUpdateDTD   = "updateDTD"
	DirectoryActionReadDTD     = "readDTD"
	DirectoryActionReadAllDTDs = "readAllDTDs"
	DirectoryActionRemoveDTD   = "removeDTD"
	DirectoryActionQueryDTDs   = "queryDTDs"
)
...
func DirectoryQueryDTDs(hc hubclient.IConsumerClient, limit int, offset int, query string) (tDdocuments []string, err error) {
...
func DirectoryReadAllDTDs(hc hubclient.IConsumerClient, limit int, offset int) (tDlist []string, err error) {
...
func DirectoryReadDTD(hc hubclient.IConsumerClient, thingID string) (tD string, err error) {
...
func DirectoryRemoveDTD(hc hubclient.IConsumerClient, dThingID string) (err error) {
...
func DirectoryUpdateDTD(hc hubclient.IConsumerClient, tD string) (err error) {
...
const DirectoryTD = `{"deny":["none"],"@context":["https://www.w3.org/2022/wot/td/v1.1",{"ht":"https://www.hiveot.net/vocab/v0.1"}],"@type":"Service","created":"2024-04-21T17:00:00.000Z","description":"HiveOT digital twin directory service","id":"directory","modified":"2024-04-21T17:00:00.000Z","support":"https://www.github.com/hiveot/hub","title":"DigiTwin Directory Service","actions":{"queryDTDs":{"@type":"ht:function","title":"Query DTDs","description":"Query digital twin TD documents from the directory","input":{"readOnly":false,"type":"object","properties":{"limit":{"title":"Max entries","description":"Maximum number of entries to return","default":100,"readOnly":false,"type":"integer","minimum":1},"offset":{"title":"Result offset","description":"Number of results to skip","default":0,"readOnly":false,"type":"integer"},"query":{"title":"Query Things","description":"JSON Query expression (tbd)","readOnly":false,"type":"string"}}},"output":{"title":"TD documents","description":"List of JSON encoded TD documents","readOnly":false,"type":"array","items":{"readOnly":false,"type":"string"}},"idempotent":true},"readAllDTDs":{"@type":"ht:function","title":"Read all TDs","description":"Read a batch of TD documents","input":{"readOnly":false,"type":"object","properties":{"limit":{"title":"Limit","description":"Maximum number of documents to return","default":100,"readOnly":false,"type":"integer","minimum":1},"offset":{"title":"Offset","description":"Start index in the list of TD documents","default":0,"readOnly":false,"type":"integer"}}},"output":{"title":"TD list","description":"List of JSON encoded TD documents","readOnly":false,"type":"array","items":{"readOnly":false,"type":"string"}},"safe":true,"idempotent":true},"readDTD":{"@type":"ht:function","title":"Read TD","description":"Return a JSON encoded TD document","input":{"title":"Thing ID","description":"Digital Twin Thing ID of the Thing to read","readOnly":false,"type":"string"},"output":{"title":"TD","description":"A JSON encoded Thing Description Document","readOnly":false,"type":"string"},"safe":true,"idempotent":true},"removeDTD":{"@type":"ht:function","title":"Remove TD","description":"Remove a digital twin from the directory","input":{"title":"dThing ID","description":"Digital Twin Thing ID of the Thing to remove","readOnly":false,"type":"string"},"idempotent":true,"allow":["admin"]},"updateDTD":{"@type":"ht:function","title":"Update DTD","description":"Update the Digital twin TD in the directory","input":{"title":"TD","description":"Device TD document in JSON format","readOnly":false,"type":"string"},"idempotent":true,"allow":["agent"]}},"events":{"thingRemoved":{"title":"Thing Removed","description":"A Thing TD was removed from the directory","data":{"title":"Thing ID","description":"ID of the digital twin Thing that was removed","readOnly":false,"type":"string"}},"thingUpdated":{"title":"Thing Updated","description":"A digital twin Thing TD was updated in the directory","data":{"title":"TD","description":"JSON encoded TD of the digital twin Thing","readOnly":false,"type":"string"}}},"security":["bearer"],"securityDefinitions":{"bearer":{"description":"HTTP protocol authentication","scheme":"bearer","name":"authentication","alg":"es256","format":"jwt","in":"header"}}}`
