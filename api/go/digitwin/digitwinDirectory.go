...
func DirectoryReadAllTDs(hc *messaging.Consumer, limit int, offset int)(tDlist []string, err error){
...
func DirectoryReadTD(hc *messaging.Consumer, thingID string)(tD string, err error){
...
func DirectoryRemoveTD(hc *messaging.Consumer, dThingID string)(err error){
...
func DirectoryUpdateTD(hc *messaging.Consumer, tD string)(err error){
...
// NewHandleDirectoryRequest returns an agent handler for Thing 'dtw:digitwin:directory' requests.
//
...
func NewHandleDirectoryRequest(svc IDirectoryService)(func(msg *transports.RequestMessage, c transports.IConnection) *transports.ResponseMessage) {
