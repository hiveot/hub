...
func DirectoryReadAllTDs(hc transports.IConsumer, limit int, offset int) (tDlist []string, err error) {
...
func DirectoryReadTD(hc transports.IConsumer, thingID string) (tD string, err error) {
...
func DirectoryRemoveTD(hc transports.IConsumer, dThingID string) (err error) {
...
func DirectoryUpdateTD(hc transports.IConsumer, tD string) (err error) {
