...
func OutboxReadLatest(hc hubclient.IHubClient, keys []string, messageType string, since string, thingID string) (valuemap map[string]interface{}, err error) {
	var args = OutboxReadLatestArgs{keys, messageType, since, thingID}
...
const OutboxTD = `{"@context":["https://www.w3.org/2022/wot/td/v1.1",{"ht":"https://www.hiveot.net/vocab/v0.1"}],"@type":"Service","created":"2024-04-26T17:00:00.000Z","description":"HiveOT digital twin outbox event storage","id":"outbox","modified":"2024-04-26T17:00:00.000Z","support":"https://www.github.com/hiveot/hub","title":"DigiTwin Outbox","actions":{"readLatest":{"@type":"ht:function","title":"Read Latest","description":"Read the latest value(s) of a Thing","input":{"readOnly":false,"type":"object","properties":{"keys":{"title":"Value Name","description":"The event/property IDs to read or empty to read all latest values","readOnly":false,"type":"array","items":{"readOnly":false,"type":"string"}},"messageType":{"title":"Message Type","description":"Message type to read, eg events or properties","enum":["events","properties"],"readOnly":false,"type":"string"},"since":{"title":"Since","description":"Only return values updated since","readOnly":false,"type":"dateTime"},"thingID":{"title":"Thing ID","description":"ID of the Thing to read","readOnly":false,"type":"string"}},"required":["thingID"]},"output":{"@type":"ht:ThingMessageMap","title":"Value map","description":"JSON encoded map of key:ThingMessage objects","readOnly":false,"type":"object"},"safe":true,"idempotent":true},"removeValue":{"@type":"ht:function","title":"Remove Thing Value","description":"Remove a value","input":{"title":"Message ID","description":"ID of the message to remove","readOnly":false,"type":"string"},"idempotent":true}},"events":{"valueUpdated":{"title":"Thing property updated","description":"A Thing's property value was updated","data":{"readOnly":false,"type":"object","properties":{"key":{"title":"Property key","description":"ID of the property that was updated","readOnly":false,"type":"string"},"thingID":{"title":"Thing ID","description":"ID of the Thing that was updated","readOnly":false,"type":"string"},"value":{"title":"New value","description":"The new value of the property","readOnly":false,"type":"string"}}}}},"security":["bearer"],"securityDefinitions":{"bearer":{"description":"HTTP protocol authentication","scheme":"bearer","name":"authentication","alg":"es256","format":"jwt","in":"header"}}}`
