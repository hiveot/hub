...
func InboxReadLatest(hc hubclient.IHubClient, name string, thingID string) (inboxRecord InboxRecord, err error) {
	var args = InboxReadLatestArgs{name, thingID}
...
const InboxTD = `{"@context":["https://www.w3.org/2022/wot/td/v1.1",{"ht":"https://www.hiveot.net/vocab/v0.1"}],"@type":"Service","created":"2024-05-03T17:00:00.000Z","description":"HiveOT digital twin inbox action storage","id":"inbox","modified":"2024-05-03T17:00:00.000Z","support":"https://www.github.com/hiveot/hub","title":"DigiTwin Inbox","schemaDefinitions":{"inboxRecord":{"title":"Inbox Record","description":"Record of action request and delivery progress","readOnly":false,"type":"object","properties":{"delivered":{"title":"Delivered Timestamp","description":"DateTime in RFC3339milli the action was delivered to the device agent","readOnly":false,"type":"string"},"error":{"description":"Error if the request could not be completed","readOnly":false,"type":"string"},"input":{"title":"Action Input","description":"Action input parameters","readOnly":false},"messageID":{"description":"Message ID linking requests and delivery updates","readOnly":false,"type":"string"},"messageType":{"description":"Message action types","enum":["action","properties"],"readOnly":false,"type":"string"},"name":{"description":"Action name to invoke","readOnly":false,"type":"string"},"progress":{"description":"Delivery progress","enum":["queued","received","applied","completed","failed"],"readOnly":false,"type":"string"},"received":{"title":"Received Timestamp","description":"DateTime in RFC3339milli the action was received by the inbox","readOnly":false,"type":"string"},"senderID":{"description":"Connection ID of the sender. Used to send delivery updates.","readOnly":false,"type":"string"},"thingID":{"description":"Digitwin Thing ID the action is directed at","readOnly":false,"type":"string"},"timestamp":{"title":"Timestamp of creation","description":"Timestamp in milliseconds since epoch this record was created","readOnly":false,"type":"integer"},"updated":{"title":"Updated Timestamp","description":"DateTime in RFC3339milli the delivery status was last updated","readOnly":false,"type":"string"}}}},"actions":{"readLatest":{"@type":"ht:function","title":"Read Latest","description":"Read the latest Thing action record from the inbox","input":{"readOnly":false,"type":"object","properties":{"name":{"title":"Name","description":"The action name to read","readOnly":false,"type":"string"},"thingID":{"title":"Thing ID","description":"ID of the Thing to read","readOnly":false,"type":"string"}},"required":["thingID","name"]},"output":{"title":"Inbox Record","description":"Action records","readOnly":false,"type":"object","$ref":"inboxRecord"},"safe":true,"idempotent":true}},"forms":[{"additionalResponses":[{"schema":"error","success":false}],"contentType":"text/event-stream","href":"/properties","htv:methodName":"GET","op":"observeallproperties","subprotocol":"sse"},{"additionalResponses":[{"schema":"error","success":false}],"contentType":"text/event-stream","href":"/events","htv:methodName":"GET","op":"subscribeallevents","subprotocol":"sse"},{"contentType":"application/json","href":"/action/{name}","htv:methodName":"POST","op":"invokeaction"},{"contentType":"application/json","href":"/properties","htv:methodName":"GET","op":"readallproperties"},{"contentType":"application/json","href":"/property/{name}","htv:methodName":"GET","op":"readproperty"},{"contentType":"application/json","href":"/property/{name}","htv:methodName":"POST","op":"writeproperty"}],"security":["bearer"],"securityDefinitions":{"bearer":{"description":"HTTP protocol authentication","scheme":"bearer","name":"authentication","alg":"es256","format":"jwt","in":"header"}}}`
