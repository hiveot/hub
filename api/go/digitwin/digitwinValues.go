...
func NewHandleValuesAction(svc IValuesService) func(consumerID, dThingID, name string, input any, requestID string) (string, any, error) {
	return func(consumerID, dThingID, actionName string, input any, requestID string) (string, any, error) {
		var err error
		var status = vocab.RequestCompleted
		var output any
		switch actionName {
		case "readEvent":
