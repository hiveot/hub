...
func ValuesQueryAction(hc *messaging.Consumer, name string, thingID string)(actionvalue ActionStatus, err error){
...
func ValuesReadAllEvents(hc *messaging.Consumer, thingID string)(eventvalues []ThingValue, err error){
...
func ValuesReadAllProperties(hc *messaging.Consumer, thingID string)(propertyvalues []ThingValue, err error){
...
func ValuesReadEvent(hc *messaging.Consumer, name string, thingID string)(eventvalue ThingValue, err error){
...
func ValuesReadProperty(hc *messaging.Consumer, name string, thingID string)(propertyvalue ThingValue, err error){
...
// NewHandleValuesRequest returns an agent handler for Thing 'dtw:digitwin:values' requests.
//
...
func NewHandleValuesRequest(svc IValuesService)(func(msg *transports.RequestMessage, c transports.IConnection) *transports.ResponseMessage) {
