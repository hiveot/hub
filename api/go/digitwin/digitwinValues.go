...
func ValuesQueryAction(td1 *td.TD, hc transports.IClientConnection, name string, thingID string) (actionvalue ActionValue, err error) {
	var args = ValuesQueryActionArgs{name, thingID}
	f := td1.GetForm("invokeaction", ValuesQueryActionMethod, hc.GetProtocolType())
	err = hc.SendRequest(f, ValuesDThingID, ValuesQueryActionMethod, &args, &actionvalue)
	return
}

// ValuesQueryAllActions client method - All actions.
// Read the current status for all actions of a Thing
func ValuesQueryAllActions(td1 *td.TD, hc transports.IClientConnection, thingID string) (actionvalues []ActionValue, err error) {

	f := td1.GetForm("invokeaction", ValuesQueryAllActionsMethod, hc.GetProtocolType())
	err = hc.SendRequest(f, ValuesDThingID, ValuesQueryAllActionsMethod, &thingID, &actionvalues)
	return
}

// ValuesReadAllEvents client method - Read all event values.
// Read the latest known event values of a Thing
func ValuesReadAllEvents(td1 *td.TD, hc transports.IClientConnection, thingID string) (eventvalues []ThingValue, err error) {

	f := td1.GetForm("invokeaction", ValuesReadAllEventsMethod, hc.GetProtocolType())
	err = hc.SendRequest(f, ValuesDThingID, ValuesReadAllEventsMethod, &thingID, &eventvalues)
	return
}

// ValuesReadAllProperties client method - Read all properties.
// Read the latest known property values
func ValuesReadAllProperties(td1 *td.TD, hc transports.IClientConnection, thingID string) (propertyvalues []ThingValue, err error) {

	f := td1.GetForm("invokeaction", ValuesReadAllPropertiesMethod, hc.GetProtocolType())
	err = hc.SendRequest(f, ValuesDThingID, ValuesReadAllPropertiesMethod, &thingID, &propertyvalues)
	return
}

// ValuesReadEvent client method - Read event value.
// Read the latest event value of a Thing
func ValuesReadEvent(td1 *td.TD, hc transports.IClientConnection, name string, thingID string) (eventvalue ThingValue, err error) {
	var args = ValuesReadEventArgs{name, thingID}
	f := td1.GetForm("invokeaction", ValuesReadEventMethod, hc.GetProtocolType())
	err = hc.SendRequest(f, ValuesDThingID, ValuesReadEventMethod, &args, &eventvalue)
	return
}

// ValuesReadProperty client method - Read property value.
// Read the latest property value
func ValuesReadProperty(td1 *td.TD, hc transports.IClientConnection, name string, thingID string) (propertyvalue ThingValue, err error) {
	var args = ValuesReadPropertyArgs{name, thingID}
	f := td1.GetForm("invokeaction", ValuesReadPropertyMethod, hc.GetProtocolType())
	err = hc.SendRequest(f, ValuesDThingID, ValuesReadPropertyMethod, &args, &propertyvalue)
	return
}
