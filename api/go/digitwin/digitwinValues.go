...
func ValuesQueryAction(hc transports.IClientConnection, name string, thingID string) (actionvalue ActionValue, err error) {
	var args = ValuesQueryActionArgs{name, thingID}
	err = hc.SendRequest("invokeaction", ValuesDThingID, ValuesQueryActionMethod, &args, &actionvalue)
	return
}

// ValuesQueryAllActions client method - All actions.
// Read the current status for all actions of a Thing
func ValuesQueryAllActions(hc transports.IClientConnection, thingID string) (actionvalues []ActionValue, err error) {

	err = hc.SendRequest("invokeaction", ValuesDThingID, ValuesQueryAllActionsMethod, &thingID, &actionvalues)
	return
}

// ValuesReadAllEvents client method - Read all event values.
// Read the latest known event values of a Thing
func ValuesReadAllEvents(hc transports.IClientConnection, thingID string) (eventvalues []ThingValue, err error) {

	err = hc.SendRequest("invokeaction", ValuesDThingID, ValuesReadAllEventsMethod, &thingID, &eventvalues)
	return
}

// ValuesReadAllProperties client method - Read all properties.
// Read the latest known property values
func ValuesReadAllProperties(hc transports.IClientConnection, thingID string) (propertyvalues []ThingValue, err error) {

	err = hc.SendRequest("invokeaction", ValuesDThingID, ValuesReadAllPropertiesMethod, &thingID, &propertyvalues)
	return
}

// ValuesReadEvent client method - Read event value.
// Read the latest event value of a Thing
func ValuesReadEvent(hc transports.IClientConnection, name string, thingID string) (eventvalue ThingValue, err error) {
	var args = ValuesReadEventArgs{name, thingID}
	err = hc.SendRequest("invokeaction", ValuesDThingID, ValuesReadEventMethod, &args, &eventvalue)
	return
}

// ValuesReadProperty client method - Read property value.
// Read the latest property value
func ValuesReadProperty(hc transports.IClientConnection, name string, thingID string) (propertyvalue ThingValue, err error) {
	var args = ValuesReadPropertyArgs{name, thingID}
	err = hc.SendRequest("invokeaction", ValuesDThingID, ValuesReadPropertyMethod, &args, &propertyvalue)
	return
}
...
func NewHandleValuesAction(svc IValuesService) func(msg *transports.ThingMessage) (any, error) {
