...
func AdminAddAgent(hc *messaging.Consumer, clientID string, displayName string, pubKey string)(token string, err error){
...
func AdminAddConsumer(hc *messaging.Consumer, clientID string, displayName string, password string)(err error){
...
func AdminAddService(hc *messaging.Consumer, clientID string, displayName string, pubKey string)(token string, err error){
...
func AdminGetClientProfile(hc *messaging.Consumer, clientID string)(profile ClientProfile, err error){
...
func AdminGetProfiles(hc *messaging.Consumer)(clientProfiles []ClientProfile, err error){
...
func AdminNewAgentToken(hc *messaging.Consumer, agentID string)(token string, err error){
...
func AdminRemoveClient(hc *messaging.Consumer, clientID string)(err error){
...
func AdminSetClientPassword(hc *messaging.Consumer, clientID string, password string)(err error){
...
func AdminUpdateClientProfile(hc *messaging.Consumer, clientProfile ClientProfile)(err error){
...
// NewHandleAdminRequest returns an agent handler for Thing 'dtw:authn:admin' requests.
//
