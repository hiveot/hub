...
func AdminAddAgent(hc transports.IClientConnection, clientID string, displayName string, pubKey string) (token string, err error) {
	var args = AdminAddAgentArgs{clientID, displayName, pubKey}
	err = hc.SendRequest("invokeaction", AdminDThingID, AdminAddAgentMethod, &args, &token)
	return
}

// AdminAddConsumer client method - Add Consumer.
// Add an end-user client
func AdminAddConsumer(hc transports.IClientConnection, clientID string, displayName string, password string) (err error) {
	var args = AdminAddConsumerArgs{clientID, displayName, password}
	err = hc.SendRequest("invokeaction", AdminDThingID, AdminAddConsumerMethod, &args, nil)
	return
}

// AdminAddService client method - Add Service.
// Add a service account
func AdminAddService(hc transports.IClientConnection, clientID string, displayName string, pubKey string) (token string, err error) {
	var args = AdminAddServiceArgs{clientID, displayName, pubKey}
	err = hc.SendRequest("invokeaction", AdminDThingID, AdminAddServiceMethod, &args, &token)
	return
}

// AdminGetClientProfile client method - Get Client Profile.
// Get the profile information describing a client
func AdminGetClientProfile(hc transports.IClientConnection, clientID string) (profile ClientProfile, err error) {

	err = hc.SendRequest("invokeaction", AdminDThingID, AdminGetClientProfileMethod, &clientID, &profile)
	return
}

// AdminGetProfiles client method - Get Profiles.
// Get a list of all client profiles
func AdminGetProfiles(hc transports.IClientConnection) (clientProfiles []ClientProfile, err error) {

	err = hc.SendRequest("invokeaction", AdminDThingID, AdminGetProfilesMethod, nil, &clientProfiles)
	return
}

// AdminNewAgentToken client method - New Agent Token.
// Obtain a new authentication token for an agent or service
func AdminNewAgentToken(hc transports.IClientConnection, agentID string) (token string, err error) {

	err = hc.SendRequest("invokeaction", AdminDThingID, AdminNewAgentTokenMethod, &agentID, &token)
	return
}

// AdminRemoveClient client method - Remove Client.
// Remove a client account
func AdminRemoveClient(hc transports.IClientConnection, clientID string) (err error) {

	err = hc.SendRequest("invokeaction", AdminDThingID, AdminRemoveClientMethod, &clientID, nil)
	return
}

// AdminSetClientPassword client method - Set Client Password.
// Update the password of a consumer
func AdminSetClientPassword(hc transports.IClientConnection, clientID string, password string) (err error) {
	var args = AdminSetClientPasswordArgs{clientID, password}
	err = hc.SendRequest("invokeaction", AdminDThingID, AdminSetClientPasswordMethod, &args, nil)
	return
}

// AdminUpdateClientProfile client method - Update Client Profile.
// Update the details of a client
func AdminUpdateClientProfile(hc transports.IClientConnection, clientProfile ClientProfile) (err error) {

	err = hc.SendRequest("invokeaction", AdminDThingID, AdminUpdateClientProfileMethod, &clientProfile, nil)
	return
}
...
// NewHandleAdminAction returns an agent handler for Thing 'dtw:authn:admin' actions.
//
...
func NewHandleAdminAction(svc IAdminService) func(msg *transports.ThingMessage) (any, error) {
	return func(msg *transports.ThingMessage) (output any, err error) {
		switch msg.Name {
		case "removeClient":
			var args string
