...
func AdminAddAgent(hc transports.IConsumerConnection, clientID string, displayName string, pubKey string) (token string, err error) {
...
func AdminAddConsumer(hc transports.IConsumerConnection, clientID string, displayName string, password string) (err error) {
...
func AdminAddService(hc transports.IConsumerConnection, clientID string, displayName string, pubKey string) (token string, err error) {
...
func AdminGetClientProfile(hc transports.IConsumerConnection, clientID string) (profile ClientProfile, err error) {
...
func AdminGetProfiles(hc transports.IConsumerConnection) (clientProfiles []ClientProfile, err error) {
...
func AdminNewAgentToken(hc transports.IConsumerConnection, agentID string) (token string, err error) {
...
func AdminRemoveClient(hc transports.IConsumerConnection, clientID string) (err error) {
...
func AdminSetClientPassword(hc transports.IConsumerConnection, clientID string, password string) (err error) {
...
func AdminUpdateClientProfile(hc transports.IConsumerConnection, clientProfile ClientProfile) (err error) {
