...
func AdminAddAgent(hc hubclient.IConsumerClient, clientID string, displayName string, pubKey string) (token string, err error) {
...
func AdminAddConsumer(hc hubclient.IConsumerClient, clientID string, displayName string, password string) (err error) {
...
func AdminAddService(hc hubclient.IConsumerClient, clientID string, displayName string, pubKey string) (token string, err error) {
...
func AdminGetClientProfile(hc hubclient.IConsumerClient, clientID string) (profile ClientProfile, err error) {
...
func AdminGetProfiles(hc hubclient.IConsumerClient) (clientProfiles []ClientProfile, err error) {
...
func AdminNewAgentToken(hc hubclient.IConsumerClient, agentID string) (token string, err error) {
...
func AdminRemoveClient(hc hubclient.IConsumerClient, clientID string) (err error) {
...
func AdminSetClientPassword(hc hubclient.IConsumerClient, clientID string, password string) (err error) {
...
func AdminUpdateClientProfile(hc hubclient.IConsumerClient, clientProfile ClientProfile) (err error) {
...
func NewHandleAdminAction(svc IAdminService) func(consumerID, dThingID, name string, input any, requestID string) (string, any, error) {
