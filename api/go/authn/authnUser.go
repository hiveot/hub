...
func UserGetProfile(hc hubclient.IConsumerClient) (resp ClientProfile, err error) {
...
// Login with password
func UserLogin(hc hubclient.IConsumerClient, clientID string, password string) (token string, err error) {
...
func UserLogout(hc hubclient.IConsumerClient) (err error) {
...
func UserRefreshToken(hc hubclient.IConsumerClient, clientID string, oldToken string) (token string, err error) {
...
func UserUpdateName(hc hubclient.IConsumerClient, newName string) (err error) {
...
func UserUpdatePassword(hc hubclient.IConsumerClient, password string) (err error) {
...
func UserUpdatePubKey(hc hubclient.IConsumerClient, publicKeyPEM string) (err error) {
...
func NewHandleUserAction(svc IUserService) func(consumerID, dThingID, name string, input any, requestID string) (string, any, error) {
...
const UserTD = `{"actions":{"getProfile":{"@type":"ht:function","title":"Get Client Profile","output":{"readOnly":false,"type":"ClientProfile"},"safe":true},"login":{"@type":"ht:function","description":"Login with password","title":"Login","input":{"readOnly":false,"type":"object","properties":{"clientID":{"title":"Login ID","readOnly":false,"type":"string"},"password":{"title":"Password","readOnly":false,"type":"string"}}},"output":{"title":"Token","readOnly":false,"type":"string"}},"logout":{"@type":"ht:function","description":"Logout from all devices","title":"Logout","idempotent":true},"refreshToken":{"@type":"ht:function","title":"Request a new auth token for the current client","input":{"readOnly":false,"type":"object","properties":{"clientID":{"title":"ClientID","readOnly":false,"type":"string"},"oldToken":{"title":"Old Token","readOnly":false,"type":"string"}}},"output":{"title":"Token","readOnly":false,"type":"string"}},"updateName":{"@type":"ht:function","title":"Request changing the display name of the current client","idempotent":true,"input":{"title":"New Name","readOnly":false,"type":"string"}},"updatePassword":{"@type":"ht:function","description":"Request changing the password of the current client","title":"Update Password","idempotent":true,"input":{"title":"Password","readOnly":false,"type":"string"}},"updatePubKey":{"@type":"ht:function","description":"Request changing the public key on file of the current client.","title":"Update Public Key","idempotent":true,"input":{"title":"Public Key PEM","description":"Public Key in PEM format","readOnly":false,"type":"string"}}},"@context":["https://www.w3.org/2022/wot/td/v1.1",{"ht":"https://www.hiveot.net/vocab/v0.1"}],"@type":"Service","created":"2024-06-04T17:00:00.000Z","deny":["none"],"description":"HiveOT runtime service for users","id":"user","modified":"2024-06-04T17:00:00.000Z","schemaDefinitions":{"ClientProfile":{"title":"Client Profile","description":"This contains client information of device agents, services and consumers","readOnly":false,"type":"object","properties":{"clientID":{"title":"Client ID","readOnly":false,"type":"string"},"clientType":{"title":"Client Type","readOnly":false,"type":"ClientType"},"disabled":{"title":"Disabled","description":"This client account has been disabled","readOnly":false,"type":"bool"},"displayName":{"title":"Display Name","readOnly":false,"type":"string"},"pubKey":{"title":"Public Key","readOnly":false,"type":"string"},"updated":{"title":"Updated timestamp in msec since epoch","readOnly":false,"type":"int64"}}},"ClientType":{"title":"Client Type","description":"identifies the client's category","oneOf":[{"title":"Agent","description":"Agents represent one or more devices","const":"agent","readOnly":false},{"title":"Service","description":"Service enrich information","const":"service","readOnly":false},{"title":"Consumer","description":"Consumers are end-users of information","const":"consumer","readOnly":false}],"readOnly":false,"type":"string"}},"security":["bearer"],"securityDefinitions":{"bearer":{"scheme":""}},"title":"Authentication User Service","support":"https://www.github.com/hiveot/hub"}`
