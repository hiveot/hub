...
func UserGetProfile(hc transports.IConsumerConnection) (resp ClientProfile, err error) {
...
func UserLogin(hc transports.IConsumerConnection, clientID string, password string) (token string, err error) {
...
func UserLogout(hc transports.IConsumerConnection) (err error) {
...
func UserRefreshToken(hc transports.IConsumerConnection, clientID string, oldToken string) (token string, err error) {
	var args = UserRefreshTokenArgs{clientID, oldToken}
	err = hc.Rpc("invokeaction", UserDThingID, UserRefreshTokenMethod, &args, &token)
	return
    return
}

func UserUpdateName(hc transports.IConsumerConnection, newName string) (err error) {
...
func UserUpdatePassword(hc transports.IConsumerConnection, password string) (err error) {
...
func UserUpdatePubKey(hc transports.IConsumerConnection, publicKeyPEM string) (err error) {
...
//
// 
func NewHandleUserAction(svc IUserService) func(msg transports.RequestMessage) transports.ResponseMessage {
