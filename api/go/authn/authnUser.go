...
// Thing names
const (
	UserActionValidateToken  = "validateToken"
...
func UserValidateToken(hc hubclient.IConsumerClient, token string) (resp UserValidateTokenResp, err error) {
