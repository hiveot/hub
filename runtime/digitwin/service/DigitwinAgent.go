...
type DigitwinAgent struct {
	svc           *DigitwinService
	dirHandler    transports.ActionHandler
	valuesHandler transports.ActionHandler
}

// HandleAction digitwin services request (args order as generated by tdd2go)
func (agent *DigitwinAgent) HandleAction(msg *transports.ThingMessage) (stat transports.RequestStatus) {
