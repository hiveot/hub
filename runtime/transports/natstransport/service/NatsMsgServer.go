...
func NewNatsMsgServer(
	cfg *natsmsgserver.NatsServerConfig, rolePermissions map[string][]msgserver_old.RolePermission) *NatsMsgServer {

	srv := &NatsMsgServer{Config: cfg,
		rolePermissions:    rolePermissions,
		servicePermissions: make(map[string][]msgserver_old.RolePermission, 0),
	}
	return srv
}
