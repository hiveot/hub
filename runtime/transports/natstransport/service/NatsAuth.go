...
func (srv *NatsMsgServer) CreateJWTToken(authInfo msgserver_old.ClientAuthInfo) (newToken string, err error) {
...
func (srv *NatsMsgServer) GetClientAuth(clientID string) (msgserver_old.ClientAuthInfo, error) {
...
func (srv *NatsMsgServer) MakeJWTPermissions(clientInfo msgserver_old.ClientAuthInfo) jwt.Permissions {
...
func (srv *NatsMsgServer) MakePermissions(clientInfo msgserver_old.ClientAuthInfo) *server.Permissions {
	...
	subInbox := hubclient.MessageTypeINBOX + "." + clientInfo.ClientID + ".>"
	subPerm.Allow = append(subPerm.Allow, subInbox)
	pubInbox := hubclient.MessageTypeINBOX + ".>"
