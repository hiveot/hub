...
type ITransportBinding interface {
	...
	SendToClient(clientID string, msg *things.ThingMessage) (stat hubclient.DeliveryStatus, found bool)

	// SendEvent publishes an event message to all subscribers of this protocol binding
	SendEvent(event *things.ThingMessage) hubclient.DeliveryStatus
