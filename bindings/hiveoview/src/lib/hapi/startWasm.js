...
export const startWasmServer = async function (fileName) {
	// import wasm_exec after setting globalThis. Use import function.
	// note that this can fail if the env vars exceed 8192 bytes.
	// workaround: edit wasm_exec.saver.js:508 to exclude XDG_ variables as these are big
	await import('./wasm_exec.cjs');
