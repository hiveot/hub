...
var AttrConfig = map[string]AttrConversion{
	...
	"Counter1": {IsProp: true, Ignore: true,
		Title: "Sample counter 1", DataType: vocab.WoTDataTypeInteger,
	},
	"Counter2": {IsProp: true, Ignore: true,
		Title: "Sample counter 2", DataType: vocab.WoTDataTypeInteger,
	},
	"DataErrorsChannel1": {IsProp: true,
		Title: "Data Errors Channel 1", DataType: vocab.WoTDataTypeInteger,
	},
	"DataErrorsChannel2": {IsProp: true,
		Title: "Data Errors Channel 2", DataType: vocab.WoTDataTypeInteger,
	},
	"DataErrorsChannel3": {IsProp: true,
		Title: "Data Errors Channel 3", DataType: vocab.WoTDataTypeInteger,
	},
	...
	"DevicesConnectedChannel1": {IsProp: true,
		Title: "Nr Devices on Channel 1", DataType: vocab.WoTDataTypeInteger,
	},
	"DevicesConnectedChannel2": {IsProp: true,
		Title: "Nr Devices on Channel 2", DataType: vocab.WoTDataTypeInteger,
	},
	"DevicesConnectedChannel3": {IsProp: true,
		Title: "Nr Devices on Channel 3", DataType: vocab.WoTDataTypeInteger,
	},
	"DewPoint": {
		Title:     "Dew point",
	...
	"Humidex": {IsEvent: true,
		...
		DataType:  vocab.WoTDataTypeNumber, Precision: 0, ChangeNotify: 1.5,
	...
	"Resolution": {IsProp: true,
		Title:    "Resolution",
		DataType: vocab.WoTDataTypeInteger, Unit: "bits",
	},
