...
// NewMqttTransportOrg creates a new instance of the mqtt client.
//
...
func NewMqttTransportOrg(fullURL string, clientID string, caCert *x509.Certificate) *MqttHubTransport {
	if fullURL == "" {
