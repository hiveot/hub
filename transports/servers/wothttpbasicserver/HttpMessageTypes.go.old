...
// NOTE: synchronous member of action affordance is true
// NOTE: actions of hiveot embedded services will be synchronous
// * status code 200
// * content-type application/json
// * body contains JSON serialized output of the action

// asynchronous action response
// NOTE: synchronous member of action affordance is false
// NOTE: actions of external things/services will be asynchronous
// * status code 201
// * Location header set to the URL of HttpActionStatus resource
// * content-type application/json
// * body contains HttpActionStatus object below

// HttpActionStatus the status of an asynchronous action invocation request
