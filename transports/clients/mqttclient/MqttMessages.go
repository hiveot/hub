...
func (cl *MqttTransportClient) handleMessage(m *paho.Publish) {
...
func (cl *MqttTransportClient) ParseResponse(data []byte, resp interface{}) error {
	var err error
...
func (cl *MqttTransportClient) PubRequest(topic string, payload []byte) (resp []byte, err error) {
...
func (cl *MqttTransportClient) sendReply(req *paho.Publish, payload []byte, errResp error) (err error) {
...
func (cl *MqttTransportClient) SubscribeToTopic(topic string) error {
...
func (cl *MqttTransportClient) UnsubscribeFromTopic(topic string) {
