...
func (cl *MqttClientConnection) SendRequest(req *transports.RequestMessage) error {
...
func (cl *MqttClientConnection) SendResponse(resp *transports.ResponseMessage) error {
	panic("todo: implement")
}

// SetConnectHandler set the application handler for connection status updates
func (cl *MqttClientConnection) SetConnectHandler(cb transports.ConnectionHandler) {
	if cb == nil {
...
func (cl *MqttClientConnection) SetRequestHandler(cb transports.RequestHandler) {
	if cb == nil {
...
func (cl *MqttClientConnection) SetResponseHandler(cb transports.ResponseHandler) {
	if cb == nil {
