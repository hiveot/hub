...
func StartReadDirectoryService(hc *hubclient.HubClient, bucket buckets.IBucket) *ReadDirectoryService {
	...
	// listen for requests
	hc.SetRPCCapability(directoryapi.ReadDirectoryCap, capMethods)
