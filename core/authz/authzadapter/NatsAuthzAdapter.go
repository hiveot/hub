...
func (svc *NatsAuthzAdapter) GetGroup(groupName string) (grp authz.Group, err error) {
...
func (svc *NatsAuthzAdapter) GetRole(clientID string, thingID string) (role string, err error) {
	// intended for verifying during testing
	err = fmt.Errorf("not implemented here")
	return
}
func (svc *NatsAuthzAdapter) GetClientRoles(clientID string) (roles authz.RoleMap, err error) {
	err = fmt.Errorf("not implemented here")
	return
}
func (svc *NatsAuthzAdapter) GetPermissions(clientID string, thingIDs []string) (permissions map[string][]string, err error) {
	err = fmt.Errorf("not implemented here")
	return
}
...
func (svc *NatsAuthzAdapter) RemoveClient(clientID string, groupName string) error {
	// remove things
...
func (svc *NatsAuthzAdapter) RemoveClientAll(clientID string) error {
	names := svc.js.StreamNames()
	for name := range names {
...
func (svc *NatsAuthzAdapter) SetUserRole(userID string, role string, groupName string) (err error) {
